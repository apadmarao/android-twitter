...
* [x] Improve the user interface and theme the app to feel "twitter branded"
	...
	* Twitter app icon
	* Styled login screen
	* Rounded image corners on profile images
	* Animation on floating action bar
...
* [x] Display retweet and favorite count for each tweet
...
## License
    ...
    Copyright [2016] [Anirudh Padmarao]
